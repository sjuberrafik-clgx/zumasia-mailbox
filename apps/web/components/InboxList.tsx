    ...
    if (messages === null) {
        return (
            <div className="inbox-empty">
                ...
                <p className="inbox-empty__title">Checking inbox</p>
                <p className="inbox-empty__hint">New messages appear automatically.</p>
            </div>
        );
    }
    if (messages.length === 0) {
        return (
            <div className="inbox-empty">
                ...
                <p className="inbox-empty__hint">Send mail to this address and it will appear here automatically.</p>
            </div>
        );
    }
